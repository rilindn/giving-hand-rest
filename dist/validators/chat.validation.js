...
const newMessageSchema = joi_1.default
  .object({
  ...
  .or('text', 'media')
const createChatValidation = (req, res, next) =>
  (0, validator_middleware_1.default)(registerSchema, req.body, next)
exports.createChatValidation = createChatValidation
const newMessageValidation = (req, res, next) =>
  (0, validator_middleware_1.default)(newMessageSchema, req.body, next)
