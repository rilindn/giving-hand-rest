...
exports.updateProductRequestValidation =
  exports.createProductRequestValidation = void 0
const tslib_1 = require('tslib')
const joi_1 = tslib_1.__importDefault(require('joi'))
const validator_middleware_1 = tslib_1.__importDefault(
...
const updateSchema = joi_1.default.object({
  productRequestId: joi_1.default
    .string()
    .required()
...
const createProductRequestValidation = (req, res, next) =>
  (0, validator_middleware_1.default)(registerSchema, req.body, next)
exports.createProductRequestValidation = createProductRequestValidation
const updateProductRequestValidation = (req, res, next) =>
  (0, validator_middleware_1.default)(
    updateSchema,
    Object.assign(Object.assign({}, req.body), {
      productRequestId: req.params.id,
    }),
    next,
  )
