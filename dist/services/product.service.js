...
const product_model_1 = tslib_1.__importDefault(
...
function getProducts({ search, categories, limit, offset, excludeIds = '' }) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    const categoriesQuery = !!(categoriesArr === null ||
    categoriesArr === void 0
      ? void 0
        ...
        .aggregate([
          {
            $match: Object.assign(
              ...
              (excludeIdsQuery === null || excludeIdsQuery === void 0
                ? void 0
...
function getProductById(id) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      ...
      if (!product) throw new HttpException_1.default('Product not found', 404)
  ...
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      ...
      const productRequests =
        yield productRequest_service_1.default.deleteProductRequests(id)
      return product
    } catch (error) {
      throw new HttpException_1.default(error)
    }
