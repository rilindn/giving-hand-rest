...
declare function getProducts({
  ...
  offset,
  excludeIds,
}: IAllProductQuery): Promise<any[]>
declare function getMyProducts(
  id: string,
  search: string,
  categories: string,
): Promise<IProduct[]>
declare function getProductById(id: string): Promise<IProduct>
declare function createProduct(payload: IProductPayload): Promise<
  IProduct &
...
>
declare function deleteProduct(id: string): Promise<
  IProduct &
    mongoose.Document<any, any, any> & {
      _id: mongoose.Types.ObjectId
    }
