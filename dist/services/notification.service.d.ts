...
declare function newNotification(payload: INotificationPayload): Promise<
  import('../interfaces/notification.interface').INotification &
    mongoose.Document<any, any, any> & {
      _id: mongoose.Types.ObjectId
    }
>
declare function readAllNotifications(
  id: string,
