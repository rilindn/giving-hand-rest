...
declare function newNotification(payload: INotificationPayload): Promise<import("../src/interfaces/notification.interface").INotification & mongoose.Document<any, any, any> & {
