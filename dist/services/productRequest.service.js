...
const HttpException_1 = tslib_1.__importDefault(
  require('../utils/HttpException'),
)
const productRequest_model_1 = tslib_1.__importDefault(
  require('../models/productRequest.model'),
)
const notification_service_1 = tslib_1.__importDefault(
  require('../services/notification.service'),
)
const product_service_1 = tslib_1.__importDefault(
...
function getMyRequests(id, search, status) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const products = yield productRequest_model_1.default
        .aggregate(query)
...
function createProductRequest(payload) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      const productRequest = new productRequest_model_1.default(
        Object.assign({}, payload),
      )
      yield productRequest.save()
      if (productRequest) {
        const productId = productRequest.productId.toString()
        const product = yield product_service_1.default.getProductById(
          productId,
        )
        ...
        yield notification_service_1.default.newNotification(
          notificationPayload,
        )
      }
  ...
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const productRequest =
        yield productRequest_model_1.default.findByIdAndUpdate(
          productRequestId,
          payload,
          {
...
function deleteProductRequest(id) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      const productRequest =
        yield productRequest_model_1.default.findByIdAndDelete(id)
      if (!productRequest) {
        throw new HttpException_1.default('ProductRequest not found', 404)
      }
      return productRequest
