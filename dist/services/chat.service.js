...
const getMyChats = ({ id, search }) =>
  tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const chatsResolved = yield Promise.all(
        chats.map((chat) =>
          tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const otherUserKeyField =
              chat.firstUserId.toString() === id
                ? 'secondUserId'
                : 'firstUserId'
...
const getChatById = (id, otherUserKeyField) =>
  tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!chat) throw new HttpException_1.default('No chat found!')
      return chat[0]
    } catch (error) {
      throw new HttpException_1.default(error)
    }
...
const newMessage = (id, payload) =>
  tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
      const chat = yield chat_model_1.default.findById(id)
      if (!chat) throw new HttpException_1.default('Chat not found!', 404)
