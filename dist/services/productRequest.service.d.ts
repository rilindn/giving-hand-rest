...
declare function getProductRequests(): Promise<
  (IProductRequest &
...
declare function getMyRequests(
  id: string,
  search: string,
  status: string,
): Promise<IProductRequest[]>
declare function createProductRequest(payload: IProductRequestPayload): Promise<
  IProductRequest &
    mongoose.Document<any, any, any> & {
      _id: mongoose.Types.ObjectId
    }
>
declare function updateProductRequest(
  id: string,
...
>
declare function deleteProductRequest(id: string): Promise<
  IProductRequest &
    mongoose.Document<any, any, any> & {
      _id: mongoose.Types.ObjectId
    }
>
declare function deleteProductRequests(
  productId: string,
