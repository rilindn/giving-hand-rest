...
const resetToken_model_1 = tslib_1.__importDefault(
...
function signTokenPayload(user) {
  ...
  const token = jsonwebtoken_1.default.sign(
    { user: body },
    env_config_1.ACCESS_TOKEN_SECRET || '',
    {},
  )
...
function composeResetToken(email) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      ...
      if (!user) throw new HttpException_1.default('User not found', 404)
...
function resetPassword(token, password, email) {
  return tslib_1.__awaiter(this, void 0, void 0, function* () {
    try {
      ...
      const updatedUser = yield user_service_1.default.updateUser(
        user._doc._id,
        Object.assign(Object.assign({}, user._doc), { password: hashedPsw }),
      )
      if (!updatedUser) throw new HttpException_1.default('User not found', 404)
      // delete old or expired reset codes
      yield resetToken_service_1.default.deleteInvalidResetToken(email)
    } catch (error) {
      throw new HttpException_1.default(error)
