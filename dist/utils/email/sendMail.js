...
const constructTransporter = (user, magicLink) =>
  tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    transporter.use(
      'compile',
      (0, nodemailer_express_handlebars_1.default)(options),
    )
