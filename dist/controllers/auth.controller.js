...
const auth_service_1 = tslib_1.__importDefault(require("../src/services/auth.service"));
const resetToken_service_1 = tslib_1.__importDefault(require("../src/services/resetToken.service"));
const sendMail_1 = tslib_1.__importDefault(require("../src/utils/email/sendMail"));
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        passport_1.default.authenticate('local', (err, user) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.login(user, { session: false }, (error) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    if (error)
                        return next(error);
...
function requestResetPassword(req, res, next) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { user, token } = yield auth_service_1.default.composeResetToken(email);
            const magicLink = auth_service_1.default.composeMagicLink(email, token);
            const { transporter, mailOptions } = yield (0, sendMail_1.default)(user, magicLink);
...
function validateResetToken(req, res, next) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield auth_service_1.default.validateResetToken(email, token);
            return res.send(result);
        }
        catch (error) {
            next(error);
...
function resetPassword(req, res, next) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const user = yield auth_service_1.default.resetPassword(token, password, email);
            return res.send(user);
        }
        catch (error) {
            next(error);
