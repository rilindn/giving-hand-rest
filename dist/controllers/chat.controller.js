...
const chat_service_1 = tslib_1.__importDefault(require("../src/services/chat.service"));
...
function readAllMessages(req, res, next) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const chat = yield chat_service_1.default.readAllMessages(chatId, receiverId);
            return res.send(chat);
        }
        catch (error) {
            next(error);
...
const deleteMessage = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
