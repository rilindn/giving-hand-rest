...
const product_controller_1 = tslib_1.__importDefault(
...
ProductRouter.get(
  '/my-products/:id',
  product_controller_1.default.getMyProducts,
)
ProductRouter.post(
  '/',
  product_validation_1.createProductValidation,
  product_controller_1.default.createProduct,
)
ProductRouter.put(
  '/:id',
  product_validation_1.updateProductValidation,
